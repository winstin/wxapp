(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/Index/components/IndustryItem/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/Index/components/IndustryItem/index.tsx?taro&type=script&parse=COMPONENT&":
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/Index/components/IndustryItem/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \******************************************************************************************************************************************************************************/
...
var _indexModules = __webpack_require__(/*! ./index.modules.less */ "./src/pages/Index/components/IndustryItem/index.modules.less");
...
var IndustryItem = (_temp2 = _class = function (_BaseComponent) {
  ...
  function IndustryItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndustryItem.__proto__ || Object.getPrototypeOf(IndustryItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["styles", "item"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return IndustryItem;
}(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "pages/Index/components/IndustryItem/index", _temp2);
...
module.exports = __webpack_require__.p + "pages/Index/components/IndustryItem/index.wxml";

/***/ }),

/***/ "./src/pages/Index/components/IndustryItem/index.modules.less":
/*!********************************************************************!*\
  !*** ./src/pages/Index/components/IndustryItem/index.modules.less ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = {"industryItem":"index-modules__industryItem___10hSt","iconView":"index-modules__iconView___2HoaC","icon":"index-modules__icon___tx6fb","itemTitle":"index-modules__itemTitle___2eGgK"};

/***/ }),

/***/ "./src/pages/Index/components/IndustryItem/index.tsx":
/*!***********************************************************!*\
  !*** ./src/pages/Index/components/IndustryItem/index.tsx ***!
  \***********************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.tsx?taro&type=template&parse=COMPONENT& */ "./src/pages/Index/components/IndustryItem/index.tsx?taro&type=template&parse=COMPONENT&");
/* harmony import */ var _index_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.tsx?taro&type=script&parse=COMPONENT& */ "./src/pages/Index/components/IndustryItem/index.tsx?taro&type=script&parse=COMPONENT&");
...
/***/ "./src/pages/Index/components/IndustryItem/index.tsx?taro&type=script&parse=COMPONENT&":
/*!*********************************************************************************************!*\
  !*** ./src/pages/Index/components/IndustryItem/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/Index/components/IndustryItem/index.tsx?taro&type=template&parse=COMPONENT&":
/*!***********************************************************************************************!*\
  !*** ./src/pages/Index/components/IndustryItem/index.tsx?taro&type=template&parse=COMPONENT& ***!
  \***********************************************************************************************/
/*! no static exports found */
...
},[["./src/pages/Index/components/IndustryItem/index.tsx","runtime","taro","vendors"]]]);